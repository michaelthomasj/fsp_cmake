...
#define BSP_FEATURE_CGC_SCKDIVCR2_NPUCLK_MATCHES_MRICLK                 (1UL)           // Requires the bits [11:8] to match SCKDIVCR2.MRICLK.
...
#define BSP_FEATURE_I3C_HAS_OUTCTL_SDHDCYC                              (0UL)           // I3C supports SDA hold cycle.
