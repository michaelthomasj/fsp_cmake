...
fsp_err_t HW_SCE_SelfCheck1Sub (void)
{
    ...
    else
    {
        ...
        WR4_PROG(REG_1420H, 0xf6884480U, 0xd1212160U, 0x9fc8f4d5U, 0x21b02787U);

        HW_SCE_p_func101(change_endian_long(0xa9039384U), change_endian_long(0xe16926d5U), change_endian_long(0x067dedfdU), change_endian_long(0x8e0c0345U));
