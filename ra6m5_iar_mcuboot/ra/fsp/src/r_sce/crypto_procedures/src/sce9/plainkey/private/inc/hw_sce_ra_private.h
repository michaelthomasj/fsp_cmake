...
extern uint32_t const DomainParam_NIST_P192[ECC_DUMMY_DOMAIN_PARAM_SIZE];
extern uint32_t const DomainParam_NIST_P224[ECC_DUMMY_DOMAIN_PARAM_SIZE];
extern uint32_t const DomainParam_NIST_P256[ECC_DUMMY_DOMAIN_PARAM_SIZE];
extern uint32_t const DomainParam_NIST_P384[ECC_DUMMY_DOMAIN_PARAM_SIZE];
extern uint32_t const DomainParam_NIST_P521[ECC_DUMMY_DOMAIN_PARAM_SIZE];
extern uint32_t const DomainParam_NIST_Ed25519[ECC_DUMMY_DOMAIN_PARAM_SIZE];
extern uint32_t const DomainParam_Brainpool_256r1[ECC_DUMMY_DOMAIN_PARAM_SIZE];
extern uint32_t const DomainParam_Brainpool_384r1[ECC_DUMMY_DOMAIN_PARAM_SIZE];
extern uint32_t const DomainParam_Brainpool_512r1[ECC_DUMMY_DOMAIN_PARAM_SIZE];
extern uint32_t const DomainParam_Koblitz_secp256k1[ECC_DUMMY_DOMAIN_PARAM_SIZE];
...
fsp_err_t HW_SCE_UpdateOemKeyIndexSub(uint32_t * InData_LC,
                                      uint32_t * InData_Cmd,
                                      uint32_t * InData_IV,
                                      uint32_t * InData_InstData,
                                      uint32_t * OutData_KeyIndex);
...
fsp_err_t HW_SCE_GenerateAes128KeyIndexSub(uint32_t * InData_SharedKeyIndex,
                                           uint32_t * InData_SessionKey,
                                           uint32_t * InData_IV,
                                           uint32_t * InData_InstData,
                                           uint32_t * OutData_KeyIndex);
fsp_err_t HW_SCE_GenerateAes192KeyIndexSub(uint32_t * InData_SharedKeyIndex,
                                           uint32_t * InData_SessionKey,
                                           uint32_t * InData_IV,
                                           uint32_t * InData_InstData,
                                           uint32_t * OutData_KeyIndex);
fsp_err_t HW_SCE_GenerateAes256KeyIndexSub(uint32_t * InData_SharedKeyIndex,
                                           uint32_t * InData_SessionKey,
                                           uint32_t * InData_IV,
                                           uint32_t * InData_InstData,
                                           uint32_t * OutData_KeyIndex);
fsp_err_t HW_SCE_GenerateRsa2048PublicKeyIndexSub(uint32_t * InData_KeyType,
                                                  uint32_t * InData_SharedKeyIndex,
                                                  uint32_t * InData_SessionKey,
                                                  uint32_t * InData_IV,
                                                  uint32_t * InData_InstData,
                                                  uint32_t * OutData_KeyIndex);
fsp_err_t HW_SCE_GenerateRsa2048PrivateKeyIndexSub(uint32_t * InData_KeyType,
                                                   uint32_t * InData_SharedKeyIndex,
                                                   uint32_t * InData_SessionKey,
                                                   uint32_t * InData_IV,
                                                   uint32_t * InData_InstData,
                                                   uint32_t * OutData_KeyIndex);
fsp_err_t HW_SCE_GenerateEccP384PublicKeyIndexSub(uint32_t * InData_KeyType,
                                                  uint32_t * InData_SharedKeyIndex,
                                                  uint32_t * InData_SessionKey,
                                                  uint32_t * InData_IV,
                                                  uint32_t * InData_InstData,
                                                  uint32_t * OutData_KeyIndex);
fsp_err_t HW_SCE_GenerateEccP384PrivateKeyIndexSub(uint32_t * InData_KeyType,
                                                   uint32_t * InData_SharedKeyIndex,
                                                   uint32_t * InData_SessionKey,
                                                   uint32_t * InData_IV,
                                                   uint32_t * InData_InstData,
                                                   uint32_t * OutData_KeyIndex);
fsp_err_t HW_SCE_GenerateEccPublicKeyIndexSub(uint32_t * InData_KeyType,
                                              uint32_t * InData_SharedKeyIndex,
                                              uint32_t * InData_SessionKey,
                                              uint32_t * InData_CurveType,
                                              uint32_t * InData_Cmd,
                                              uint32_t * InData_IV,
                                              uint32_t * InData_InstData,
                                              uint32_t * OutData_KeyIndex);
fsp_err_t HW_SCE_GenerateEccPrivateKeyIndexSub(uint32_t * InData_KeyType,
                                               uint32_t * InData_SharedKeyIndex,
                                               uint32_t * InData_SessionKey,
                                               uint32_t * InData_CurveType,
                                               uint32_t * InData_Cmd,
                                               ...
                                               uint32_t * InData_InstData,
                                               uint32_t * OutData_KeyIndex);
fsp_err_t HW_SCE_GenerateShaHmacKeyIndexSub(uint32_t * InData_KeyType,
                                            uint32_t * InData_SharedKeyIndex,
                                            uint32_t * InData_SessionKey,
                                            uint32_t * InData_Cmd,
                                            uint32_t * InData_IV,
...
fsp_err_t HW_SCE_GenerateRsa3072RandomKeyIndexSub(const uint32_t InData_KeyMode[],
                                                  ...
                                                  uint32_t       OutData_PrivKeyIndex[],
                                                  uint32_t       OutData_PrivKey[]);
fsp_err_t HW_SCE_GenerateRsa4096RandomKeyIndexSub(uint32_t   MAX_CNT,
                                                  uint32_t * OutData_PubKeyIndex,
                                                  uint32_t * OutData_PrivKeyIndex);
...
fsp_err_t HW_SCE_GenerateUpdateKeyRingKeyIndexSub(uint32_t * InData_LC,
                                                  uint32_t * InData_SharedKeyIndex,
                                                  uint32_t * InData_SessionKey,
                                                  uint32_t * InData_IV,
                                                  uint32_t * InData_InstData,
...
fsp_err_t HW_SCE_UpdateRsa2048PublicKeyIndexSub(uint32_t * InData_IV,
                                                uint32_t * InData_InstData,
                                                uint32_t * OutData_KeyIndex);
fsp_err_t HW_SCE_UpdateRsa2048PrivateKeyIndexSub(uint32_t * InData_IV,
                                                 uint32_t * InData_InstData,
                                                 uint32_t * OutData_KeyIndex);
...
fsp_err_t HW_SCE_UpdateEccP384PrivateKeyIndexSub(uint32_t * InData_IV,
                                                 uint32_t * InData_InstData,
                                                 uint32_t * OutData_KeyIndex);
fsp_err_t HW_SCE_UpdateEccPublicKeyIndexSub(uint32_t * InData_Cmd,
                                            uint32_t * InData_IV,
                                            uint32_t * InData_InstData,
                                            uint32_t * OutData_KeyIndex);
fsp_err_t HW_SCE_UpdateEccPrivateKeyIndexSub(uint32_t * InData_Cmd,
                                             uint32_t * InData_IV,
                                             uint32_t * InData_InstData,
                                             uint32_t * OutData_KeyIndex);
fsp_err_t HW_SCE_Ecc256ScalarMultiplicationPrivate(uint32_t * InData_CurveType,
                                                   uint32_t * InData_Cmd,
...
fsp_err_t HW_SCE_Aes128XtsEncryptFinalPrivate(uint32_t * InData_TextBitLen,
...
fsp_err_t HW_SCE_Aes256XtsEncryptFinalPrivate(uint32_t * InData_TextBitLen,
                                              uint32_t * InData_Text,
                                              uint32_t * OutData_Text);
...
fsp_err_t HW_SCE_Aes128XtsDecryptFinalPrivate(uint32_t * InData_TextBitLen,
                                              uint32_t * InData_Text,
                                              uint32_t * OutData_Text);
...
fsp_err_t HW_SCE_Aes256XtsDecryptFinalPrivate(uint32_t * InData_TextBitLen,
                                              uint32_t * InData_Text,
                                              uint32_t * OutData_Text);
...
void      HW_SCE_Aes128GcmEncryptUpdateSub(const uint32_t InData_Text[], uint32_t OutData_Text[],
                                           const uint32_t MAX_CNT);
...
fsp_err_t HW_SCE_Aes128GcmEncryptFinalPrivate(uint32_t * InData_Text,
...
void      HW_SCE_Aes192GcmEncryptUpdateSub(const uint32_t InData_Text[], uint32_t OutData_Text[],
                                           const uint32_t MAX_CNT);
...
fsp_err_t HW_SCE_Aes192GcmEncryptFinalPrivate(uint32_t * InData_Text,
                                              uint32_t * InData_DataALen,
                                              uint32_t * InData_TextLen,
                                              uint32_t * OutData_Text,
                                              uint32_t * OutData_DataT);
...
void      HW_SCE_Aes256GcmEncryptUpdateSub(const uint32_t InData_Text[], uint32_t OutData_Text[],
                                           const uint32_t MAX_CNT);
...
fsp_err_t HW_SCE_Aes256GcmEncryptFinalPrivate(uint32_t * InData_Text,
                                              uint32_t * InData_DataALen,
                                              uint32_t * InData_TextLen,
                                              uint32_t * OutData_Text,
                                              uint32_t * OutData_DataT);
...
void      HW_SCE_Aes128GcmDecryptUpdateSub(const uint32_t InData_Text[], uint32_t OutData_Text[],
                                           const uint32_t MAX_CNT);
...
fsp_err_t HW_SCE_Aes128GcmDecryptFinalPrivate(uint32_t * InData_Text,
...
void      HW_SCE_Aes192GcmDecryptUpdateSub(const uint32_t InData_Text[], uint32_t OutData_Text[],
                                           const uint32_t MAX_CNT);
...
fsp_err_t HW_SCE_Aes192GcmDecryptFinalPrivate(uint32_t * InData_Text,
                                              uint32_t * InData_DataT,
                                              uint32_t * InData_DataALen,
                                              uint32_t * InData_TextLen,
                                              uint32_t * InData_DataTLen,
...
void      HW_SCE_Aes256GcmDecryptUpdateSub(const uint32_t InData_Text[], uint32_t OutData_Text[],
                                           const uint32_t MAX_CNT);
...
fsp_err_t HW_SCE_Aes256GcmDecryptFinalPrivate(uint32_t * InData_Text,
                                              uint32_t * InData_DataT,
                                              uint32_t * InData_DataALen,
                                              uint32_t * InData_TextLen,
                                              uint32_t * InData_DataTLen,
...
fsp_err_t HW_SCE_Aes256GcmDecryptFinalSub(const uint32_t InData_Text[],
                                          ...
                                          const uint32_t InData_DataTLen[],
                                          uint32_t       OutData_Text[]);
fsp_err_t HW_SCE_Aes128CcmEncryptInitPrivate(sce_aes_key_index_t * KeyIndex,
                                             uint32_t            * InData_IV,
...
void      HW_SCE_Aes128CcmEncryptUpdateSub(const uint32_t InData_Text[], uint32_t OutData_Text[],
                                           const uint32_t MAX_CNT);
fsp_err_t HW_SCE_Aes128CcmEncryptFinalPrivate(const uint32_t * InData_TextLen,
...
fsp_err_t HW_SCE_Aes128CcmEncryptFinalSubGeneral(const uint32_t * InData_Text,
                                                 ...
                                                 uint32_t       * OutData_Text,
                                                 uint32_t       * OutData_MAC);
fsp_err_t HW_SCE_Aes192CcmEncryptInitPrivate(sce_aes_key_index_t * KeyIndex,
                                             uint32_t            * InData_IV,
                                             uint32_t            * InData_Header,
                                             uint32_t              Header_Len);
...
void      HW_SCE_Aes192CcmEncryptUpdateSub(const uint32_t InData_Text[], uint32_t OutData_Text[],
                                           const uint32_t MAX_CNT);
fsp_err_t HW_SCE_Aes192CcmEncryptFinalPrivate(uint32_t * InData_TextLen,
                                              uint32_t * InData_Text,
                                              uint32_t * OutData_Text,
                                              uint32_t * OutData_MAC);
fsp_err_t HW_SCE_Aes192CcmEncryptFinalSub(const uint32_t InData_Text[],
                                          ...
                                          uint32_t       OutData_Text[],
                                          uint32_t       OutData_MAC[]);
fsp_err_t HW_SCE_Aes256CcmEncryptInitPrivate(sce_aes_key_index_t * KeyIndex,
                                             uint32_t            * InData_IV,
                                             uint32_t            * InData_Header,
                                             uint32_t              Header_Len);
...
void      HW_SCE_Aes256CcmEncryptUpdateSub(const uint32_t InData_Text[], uint32_t OutData_Text[],
                                           const uint32_t MAX_CNT);
fsp_err_t HW_SCE_Aes256CcmEncryptFinalPrivate(uint32_t * InData_TextLen,
                                              uint32_t * InData_Text,
                                              uint32_t * OutData_Text,
                                              uint32_t * OutData_MAC);
fsp_err_t HW_SCE_Aes256CcmEncryptFinalSub(const uint32_t InData_Text[],
                                          ...
                                          uint32_t       OutData_Text[],
                                          uint32_t       OutData_MAC[]);
fsp_err_t HW_SCE_Aes128CcmDecryptInitPrivate(sce_aes_key_index_t * KeyIndex,
                                             uint32_t            * InData_IV,
                                             uint32_t            * InData_Header,
                                             uint32_t              Header_Len);
...
void      HW_SCE_Aes128CcmDecryptUpdateSub(const uint32_t InData_Text[], uint32_t OutData_Text[],
                                           const uint32_t MAX_CNT);
fsp_err_t HW_SCE_Aes128CcmDecryptFinalPrivate(const uint32_t * InData_Text,
                                              const uint32_t * InData_TextLen,
...
fsp_err_t HW_SCE_Aes128CcmDecryptFinalSubGeneral(const uint32_t * InData_Text,
                                                 ...
                                                 const uint32_t * InData_MACLength,
                                                 uint32_t       * OutData_Text);
fsp_err_t HW_SCE_Aes192CcmDecryptInitPrivate(sce_aes_key_index_t * KeyIndex,
                                             uint32_t            * InData_IV,
                                             uint32_t            * InData_Header,
                                             uint32_t              Header_Len);
...
void      HW_SCE_Aes192CcmDecryptUpdateSub(const uint32_t InData_Text[], uint32_t OutData_Text[],
                                           const uint32_t MAX_CNT);
fsp_err_t HW_SCE_Aes192CcmDecryptFinalPrivate(uint32_t * InData_Text,
                                              uint32_t * InData_TextLen,
                                              uint32_t * InData_MAC,
                                              uint32_t * InData_MACLength,
                                              uint32_t * OutData_Text);
fsp_err_t HW_SCE_Aes192CcmDecryptFinalSub(const uint32_t InData_Text[],
                                          ...
                                          const uint32_t InData_MACLength[],
                                          uint32_t       OutData_Text[]);
fsp_err_t HW_SCE_Aes256CcmDecryptInitPrivate(sce_aes_key_index_t * KeyIndex,
                                             uint32_t            * InData_IV,
                                             uint32_t            * InData_Header,
                                             uint32_t              Header_Len);
...
void      HW_SCE_Aes256CcmDecryptUpdateSub(const uint32_t InData_Text[], uint32_t OutData_Text[],
                                           const uint32_t MAX_CNT);
fsp_err_t HW_SCE_Aes256CcmDecryptFinalPrivate(uint32_t * InData_Text,
                                              uint32_t * InData_TextLen,
                                              uint32_t * InData_MAC,
                                              uint32_t * InData_MACLength,
                                              uint32_t * OutData_Text);
...
fsp_err_t HW_SCE_Aes128CmacGenerateFinalPrivate(uint32_t All_Msg_Len, uint32_t * InData_Text, uint32_t * OutData_DataT);
...
fsp_err_t HW_SCE_Aes256CmacGenerateFinalPrivate(uint32_t All_Msg_Len, uint32_t * InData_Text, uint32_t * OutData_DataT);
...
fsp_err_t HW_SCE_Aes128CmacVerifyFinalPrivate(uint32_t   All_Msg_Len,
                                              uint32_t * InData_Text,
                                              uint32_t * InData_DataT,
                                              uint32_t * InData_DataTLen);
...
fsp_err_t HW_SCE_Aes256CmacVerifyFinalPrivate(uint32_t   All_Msg_Len,
                                              uint32_t * InData_Text,
                                              uint32_t * InData_DataT,
                                              uint32_t * InData_DataTLen);
...
fsp_err_t HW_SCE_Aes192CmacFinal(const uint32_t InData_Cmd[],
                                 ...
                                 const uint32_t InData_DataTLen[],
                                 uint32_t       OutData_DataT[]);
fsp_err_t HW_SCE_Aes192CmacFinalSub(uint32_t * InData_Cmd,
                                    uint32_t * InData_Text,
                                    uint32_t * InData_DataT,
                                    uint32_t * InData_DataTLen,
                                    uint32_t * OutData_DataT);
...
fsp_err_t HW_SCE_Aes256CmacFinalSub(uint32_t InData_Cmd[],
                                    ...
                                    uint32_t InData_DataTLen[],
                                    uint32_t OutData_DataT[]);
fsp_err_t HW_SCE_Aes128KeyWrapPrivate(uint32_t * InData_KeyIndex,
                                      uint32_t * InData_WrappedKeyType,
                                      uint32_t * InData_WrappedKeyIndex,
                                      uint32_t * OutData_Text);
fsp_err_t HW_SCE_Aes256KeyWrapPrivate(uint32_t * InData_KeyIndex,
                                      uint32_t * InData_WrappedKeyType,
                                      uint32_t * InData_WrappedKeyIndex,
                                      uint32_t * OutData_Text);
fsp_err_t HW_SCE_Aes128KeyUnWrapPrivate(uint32_t * InData_KeyIndex,
                                        uint32_t * InData_WrappedKeyType,
                                        uint32_t * InData_Text,
                                        uint32_t * OutData_KeyIndex);
fsp_err_t HW_SCE_Aes256KeyUnWrapPrivate(uint32_t * InData_KeyIndex,
                                        uint32_t * InData_WrappedKeyType,
                                        uint32_t * InData_Text,
                                        uint32_t * OutData_KeyIndex);
...
fsp_err_t HW_SCE_Md5FinalPrivate(sce_sha_md5_handle_t * handle,
...
fsp_err_t HW_SCE_Sha1FinalPrivate(sce_sha_md5_handle_t * handle,
                                  uint32_t             * InData_PaddedMsg,
                                  uint32_t               MAX_CNT,
                                  uint32_t             * OutData_MsgDigest,
                                  uint32_t             * OutData_Length);
...
fsp_err_t HW_SCE_Sha256FinalPrivate(sce_sha_md5_handle_t * handle,
                                    uint32_t             * InData_PaddedMsg,
                                    uint32_t               MAX_CNT,
                                    uint32_t             * OutData_MsgDigest,
                                    uint32_t             * OutData_Length);
...
fsp_err_t HW_SCE_ShaGenerateMessageDigestSubAdaptor(const uint32_t InData_InitVal[],
                                                    const uint32_t InData_PaddedMsg[],
                                                    uint32_t       OutData_MsgDigest[],
                                                    const uint32_t MAX_CNT);
...
fsp_err_t HW_SCE_Sha1HmacGenerateUpdatePrivate(sce_hmac_sha_handle_t * handle,
                                               uint32_t              * InData_PaddedMsg,
                                               uint32_t                MAX_CNT);
fsp_err_t HW_SCE_Sha1HmacGenerateFinalPrivate(sce_hmac_sha_handle_t * handle, uint32_t * OutData_Mac);
fsp_err_t HW_SCE_Sha256HmacGenerateInitPrivate(sce_hmac_sha_handle_t * handle, sce_hmac_sha_key_index_t * key_index);
fsp_err_t HW_SCE_Sha256HmacGenerateUpdatePrivate(sce_hmac_sha_handle_t * handle,
                                                 uint32_t              * InData_PaddedMsg,
                                                 uint32_t                MAX_CNT);
...
fsp_err_t HW_SCE_Sha1HmacVerifyUpdatePrivate(sce_hmac_sha_handle_t * handle,
                                             uint32_t              * InData_PaddedMsg,
                                             uint32_t                MAX_CNT);
fsp_err_t HW_SCE_Sha1HmacVerifyFinalPrivate(sce_hmac_sha_handle_t * handle,
                                            uint32_t              * InData_Mac,
...
fsp_err_t HW_SCE_Sha256HmacVerifyUpdatePrivate(sce_hmac_sha_handle_t * handle,
                                               uint32_t              * InData_PaddedMsg,
                                               uint32_t                MAX_CNT);
fsp_err_t HW_SCE_Sha256HmacFinalSub(uint32_t InData_Cmd[],
                                    ...
                                    uint32_t InData_length[],
                                    uint32_t OutData_MAC[]);
fsp_err_t HW_SCE_Sha256HmacVerifyFinalPrivate(sce_hmac_sha_handle_t * handle,
                                              uint32_t              * InData_Mac,
                                              uint32_t              * InData_length);

/* -------- RSA -------- */
fsp_err_t HW_SCE_Rsa1024ModularExponentEncryptPrivate(uint32_t * InData_KeyIndex,
                                                      uint32_t * InData_Text,
                                                      uint32_t * OutData_Text);
...
fsp_err_t HW_SCE_Rsa1024ModularExponentEncryptSubAdaptor(const uint32_t InData_KeyIndex[],
                                                         ...
                                                         const uint32_t InData_Text[],
                                                         uint32_t       OutData_Text[]);
fsp_err_t HW_SCE_Rsa1024ModularExponentDecryptPrivate(uint32_t * InData_KeyIndex,
                                                      uint32_t * InData_Text,
                                                      uint32_t * OutData_Text);
...
fsp_err_t HW_SCE_Rsa1024ModularExponentDecryptSubAdaptor(const uint32_t InData_KeyMode[],
                                                         ...
                                                         const uint32_t InData_Text[],
                                                         uint32_t       OutData_Text[]);
fsp_err_t HW_SCE_Rsa2048ModularExponentEncryptPrivate(uint32_t * InData_KeyIndex,
                                                      uint32_t * InData_Text,
                                                      uint32_t * OutData_Text);
...
fsp_err_t HW_SCE_Rsa2048ModularExponentEncryptSubAdaptor(const uint32_t InData_KeyIndex[],
                                                         ...
                                                         const uint32_t InData_Text[],
                                                         uint32_t       OutData_Text[]);
fsp_err_t HW_SCE_Rsa2048ModularExponentDecryptPrivate(uint32_t * InData_KeyIndex,
                                                      uint32_t * InData_Text,
                                                      uint32_t * OutData_Text);
...
fsp_err_t HW_SCE_Rsa2048ModularExponentDecryptSubAdaptor(const uint32_t InData_KeyMode[],
                                                         ...
                                                         const uint32_t InData_Text[],
                                                         uint32_t       OutData_Text[]);
fsp_err_t HW_SCE_Rsa3072ModularExponentEncryptPrivate(uint32_t * InData_KeyIndex,
                                                      uint32_t * InData_Text,
                                                      uint32_t * OutData_Text);
...
fsp_err_t HW_SCE_Rsa3072ModularExponentEncryptSubAdaptor(const uint32_t InData_KeyIndex[],
                                                         ...
                                                         const uint32_t InData_Text[],
                                                         uint32_t       OutData_Text[]);
fsp_err_t HW_SCE_Rsa3072ModularExponentDecryptPrivate(uint32_t * InData_KeyIndex,
                                                      uint32_t * InData_Text,
                                                      uint32_t * OutData_Text);
fsp_err_t HW_SCE_Rsa3072ModularExponentDecryptSub(uint32_t * InData_KeyIndex,
                                                  uint32_t * InData_Text,
                                                  uint32_t * OutData_Text);
fsp_err_t HW_SCE_Rsa4096ModularExponentEncryptPrivate(uint32_t * InData_KeyIndex,
                                                      uint32_t * InData_Text,
                                                      uint32_t * OutData_Text);
...
fsp_err_t HW_SCE_Rsa4096ModularExponentEncryptSubAdaptor(const uint32_t InData_KeyIndex[],
                                                         ...
                                                         const uint32_t InData_Text[],
                                                         uint32_t       OutData_Text[]);
fsp_err_t HW_SCE_Rsa4096ModularExponentDecryptPrivate(uint32_t * InData_KeyIndex,
                                                      uint32_t * InData_Text,
                                                      uint32_t * OutData_Text);
fsp_err_t HW_SCE_Rsa4096ModularExponentDecryptSub(uint32_t * InData_KeyIndex,
                                                  uint32_t * InData_Text,
                                                  uint32_t * OutData_Text);
...
/* -------- ECDH -------- */
fsp_err_t HW_SCE_EcdhReadPublicKeyPrivate(uint32_t * InData_Cmd,
                                          uint32_t * InData_KeyIndex,
                                          uint32_t * InData_data,
                                          uint32_t * InData_Signature,
                                          uint32_t * OutData_KeyIndex);
fsp_err_t HW_SCE_EcdhMakePublicKeyPrivate(uint32_t * InData_Cmd,
                                          uint32_t * InData_KeyType,
                                          ...
                                          uint32_t * OutData_Signature,
                                          uint32_t * OutData_KeyIndex);
fsp_err_t HW_SCE_EcdhCalculateSharedSecretIndexPrivate(uint32_t * InData_KeyType,
                                                       uint32_t * InData_PubKeyIndex,
                                                       uint32_t * InData_PrivKeyIndex,
                                                       uint32_t * OutData_KeyIndex);
fsp_err_t HW_SCE_EcdhKeyDerivationPrivate(uint32_t * InData_KeyIndex,
                                          uint32_t * InData_PaddedMsg,
                                          uint32_t   MAX_CNT,
                                          uint32_t * OutData_KeyIndex);

/* -------- DLMS / COSEM -------- */
fsp_err_t HW_SCE_DlmsCosemCalculateZSub(uint32_t * InData_KeyType,
                                        uint32_t * InData_PubKeyIndex,
                                        uint32_t * InData_PrivKeyIndex,
                                        uint32_t * OutData_KeyIndex);
fsp_err_t HW_SCE_DlmsCosemCalculateKekSub(uint32_t * InData_KeyIndex,
                                          uint32_t * InData_PaddedMsg,
                                          uint32_t   MAX_CNT,
                                          uint32_t * OutData_KeyIndex);
fsp_err_t HW_SCE_DlmsCosemKeyUnwrapSub(uint32_t * InData_KeyIndex, uint32_t * InData_Text, uint32_t * OutData_KeyIndex);
fsp_err_t HW_SCE_DlmsCosemQeuSignatureVerificationSub(uint32_t * InData_Cmd,
                                                      uint32_t * InData_KeyIndex,
                                                      uint32_t * InData_data,
                                                      uint32_t * InData_Signature,
                                                      uint32_t * OutData_KeyIndex);
fsp_err_t HW_SCE_DlmsCosemQevSignatureGenerationSub(uint32_t * InData_Cmd,
                                                    uint32_t * InData_KeyType,
                                                    uint32_t * InData_PubKeyIndex,
                                                    uint32_t * InData_PrivKeyIndex,
                                                    uint32_t * InData_key_id,
...
/* -------- TLS -------- */
fsp_err_t HW_SCE_TlsRootCertificateVerificationSub(uint32_t * InData_Sel_PubKeyType,
                                                   ...
                                                   uint32_t   length,
                                                   uint32_t * OutData_PubKey);
fsp_err_t HW_SCE_TlsCertificateVerificationSub(uint32_t * InData_Sel_PubKeyType,
                                               uint32_t * InData_PubKey,
...
fsp_err_t HW_SCE_TlsGenerateMasterSecretSub(uint32_t * InData_Sel_CipherSuite,
                                            uint32_t * InData_PreMasterSecret,
                                            uint32_t * InData_ClientRandom,
                                            uint32_t * InData_ServerRandom,
                                            uint32_t * OutData_MasterSecret);
fsp_err_t HW_SCE_TlsGenerateSessionKeySub(uint32_t * InData_Sel_CipherSuite,
                                          ...
                                          uint32_t   OutLen);
fsp_err_t HW_SCE_TlsGenerateVerifyDataSub(uint32_t * InData_Sel_VerifyData,
                                          uint32_t * InData_MasterSecret,
                                          uint32_t * InData_HandShakeHash,
                                          uint32_t * OutData_VerifyData);
fsp_err_t HW_SCE_TlsGeneratePreMasterSecretWithEccP256KeySub(uint32_t * InData_PubKey,
                                                             uint32_t * InData_KeyIndex,
