...
fsp_err_t HW_SCE_Rsa2048ModularExponentDecryptSub (const uint32_t InData_KeyIndex[],
                                                   ...
                                                   uint32_t       OutData_Text[])
{
    ...
    HW_SCE_p_func101(0xf8a9b604U, 0xe954d71eU, 0xe375c680U, 0x9c2533e4U);
    HW_SCE_p_func043_r1();
    ...
    HW_SCE_p_func101(0xfffbb174U, 0x75bfc5e2U, 0x6433792bU, 0xcc3c8b0cU);
    HW_SCE_p_func044_r1();
    ...
    HW_SCE_p_func100(0x3cec4e18U, 0x33c48c90U, 0xaed19689U, 0xb4b9daa3U);
    WR1_PROG(REG_143CH, 0x00400000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0x742546d6U, 0x9230ae57U, 0xe4a79ebfU, 0x1f75db74U);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0x81c1d898U, 0xa77b9099U, 0xc709c0c7U, 0xe5442ba4U);
        WR1_PROG(REG_143CH, 0x00400000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func102(0x9d7508b1U, 0x4cba1157U, 0xabd9a6c7U, 0x98a70638U);
            WR1_PROG(REG_14B8H, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
        ...
        {
            HW_SCE_p_func100(0x7a08d78dU, 0xec3bd3aeU, 0xfc23f101U, 0x1750d767U);
            ...
            for (iLoop = 0U; iLoop < 64U; )
            {
                ...
                HW_SCE_p_func100(0xa03e8738U, 0x375d2bdeU, 0x9edf133eU, 0xdbe0628cU);
                ...
                HW_SCE_p_func101(0x063ee34cU, 0x77301b2dU, 0xd9b3123cU, 0xd625104bU);
                iLoop = iLoop + 8U;
            }
            ...
            HW_SCE_p_func100(0x57b613d1U, 0x689c146fU, 0x69a1d7b6U, 0xd0a0f921U);
            WR1_PROG(REG_1408H, 0x00020000U);

            HW_SCE_p_func102(0x5fa845dcU, 0x4a460b2cU, 0x11aa304dU, 0x7674050cU);
            WR1_PROG(REG_14B8H, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
