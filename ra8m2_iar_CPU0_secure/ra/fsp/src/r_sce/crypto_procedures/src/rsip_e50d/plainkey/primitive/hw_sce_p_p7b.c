                                                   ...
                                                   uint32_t       OutData_Text[])
{
    ...
    HW_SCE_p_func101(0x0bcf902dU, 0x32839a12U, 0xf059572dU, 0xe68396deU);
    HW_SCE_p_func044_r1();
    ...
    HW_SCE_p_func100(0xbab42800U, 0x757159abU, 0x51fbe55aU, 0xeb5e4472U);
    WR1_PROG(REG_143CH, 0x00400000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0xce2ef277U, 0x572400c2U, 0x53c80342U, 0x9219af9aU);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0x7806d469U, 0x84e4d666U, 0x22f62148U, 0xcbb60742U);
        WR1_PROG(REG_143CH, 0x00400000U);

        if (CHCK_STS(REG_143CH, 22, 1))
        {
            HW_SCE_p_func102(0x8a907d96U, 0xbfc15ecaU, 0x0647f4d9U, 0xa583bdbfU);
            WR1_PROG(REG_14B8H, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
        ...
        {
            HW_SCE_p_func100(0xe5bf6f75U, 0xb566a077U, 0xa8d85286U, 0x0ee32578U);
            ...
            for (iLoop = 0U; iLoop < 128U; )
            {
                ...
                HW_SCE_p_func100(0xcf0b4186U, 0x34d0efadU, 0xb625d131U, 0x41d3824dU);
                ...
                HW_SCE_p_func101(0x5443e5e8U, 0x39775cb3U, 0x3e894e38U, 0xc51c2b82U);
                iLoop = iLoop + 8U;
            }
            ...
            HW_SCE_p_func100(0x60570070U, 0x1a99a2bbU, 0x58705c5aU, 0xedb99ea2U);
            WR1_PROG(REG_1408H, 0x00020000U);

            HW_SCE_p_func102(0x384d61e7U, 0x6b0f274eU, 0x88c52995U, 0x1827440aU);
            WR1_PROG(REG_14B8H, 0x00000040U);
            WAIT_STS(REG_142CH, 12, 0);
