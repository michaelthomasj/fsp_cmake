                                           ...
                                           uint32_t       OutData_Text[])
{
    ...
    HW_SCE_p_func100(0x9f43a831U, 0xf92073deU, 0xd93d839eU, 0x39a7d099U);
    WR1_PROG(REG_143CH, 0x00400000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0x696c2b2bU, 0xa31097e6U, 0xfd6c1b45U, 0x0b7b851fU);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0x6cf37bf7U, 0xc1c01ed1U, 0x54b0e400U, 0x89796999U);
        WR1_PROG(REG_143CH, 0x00400000U);
        ...
        if (CHCK_STS(REG_143CH, 22, 1))
        {
            ...
            HW_SCE_p_func100(0xd6ac9006U, 0x7f7001c7U, 0x5b6d2820U, 0x3b808c45U);
            WR1_PROG(REG_1600H, 0x0000b420U);
            WR1_PROG(REG_1600H, 0x00000080U);
            ...
            HW_SCE_p_func101(0xb6e33d10U, 0xdce8d3c4U, 0x20711410U, 0xe4dc57dbU);
        }
        else
        {
            HW_SCE_p_func101(0x3d2e88a1U, 0x7188c9b1U, 0x7d844715U, 0x87cc117fU);
        }
