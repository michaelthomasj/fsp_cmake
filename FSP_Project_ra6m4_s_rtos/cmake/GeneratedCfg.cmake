...
set(RASC_PROJECT_NAME FSP_Project_ra6m4_s_rtos)
...
SET(RASC_CMAKE_EXE_LINKER_FLAGS "-mcmse;-mfloat-abi=hard;-mcpu=cortex-m33;-mfpu=fpv5-sp-d16;-Wunused;-Wuninitialized;-Wall;-Wextra;-Wmissing-declarations;-Wconversion;-Wpointer-arith;-Wshadow;-Wlogical-op;-Waggregate-return;-Wfloat-equal;-fmessage-length=0;-fsigned-char;-ffunction-sections;-fdata-sections;-mthumb;-T;script/fsp.ld;-Wl,--gc-sections;-Wl,-Map,${CMAKE_CURRENT_BINARY_DIR}/${PROJECT_NAME}.map;-Wl,--cmse-implib;-Wl,--out-implib=${CMAKE_CURRENT_BINARY_DIR}/secure.o;--specs=nano.specs;-o;${CMAKE_CURRENT_BINARY_DIR}/${PROJECT_NAME}.elf")
SET(RASC_CMAKE_DEFINITIONS "_RA_CORE=CM33;_RA_TZ_SECURE;_RA_ORDINAL=1;_RENESAS_RA_")
