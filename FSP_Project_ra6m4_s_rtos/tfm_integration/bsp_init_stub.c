 ...
 *
 * Stub implementation of FSP BSP initialization structures for TF-M integration.
 * TF-M handles its own startup, so we provide minimal stubs here for FSP
 * symbols that would normally be provided by the FSP startup/linker code.
 */
