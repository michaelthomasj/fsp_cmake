...
void HW_SCE_p_func055 (void)
{
    ...
    while (1)
    {
        ...
        HW_SCE_p_func100(0xc1219541U, 0x85dce9f9U, 0x5940aa40U, 0x5e53e420U);
        ...
        if (CHCK_STS(REG_143CH, 22, 1))
        {
            ...
            HW_SCE_p_func100(0xda3f6201U, 0x0f66f16dU, 0x50fa83beU, 0x0aa8902eU);
            WR1_PROG(REG_143CH, 0x00400000U);
            ...
            if (CHCK_STS(REG_143CH, 22, 1))
            {
                ...
                HW_SCE_p_func101(0xac410176U, 0x3450e020U, 0xa50fdea6U, 0x0d41fe5aU);
            }
            else
            {
                ...
                HW_SCE_p_func101(0xf1972611U, 0x73fa965eU, 0xe55c6668U, 0x7b5ef5e0U);
                HW_SCE_p_func304();
                ...
                HW_SCE_p_func101(0xc6520eadU, 0x1432192fU, 0xf154476bU, 0x6e919a76U);
                ...
                HW_SCE_p_func101(0xe8866b2eU, 0x3cca8eafU, 0x6ae5d661U, 0x4d1e9571U);
                HW_SCE_p_func305();
                ...
                HW_SCE_p_func101(0x33327250U, 0x1342d802U, 0x10466c41U, 0x49caef28U);
            }
        }
        else
        {
            HW_SCE_p_func101(0xd61ec382U, 0xa6aa3207U, 0xa5dad9ccU, 0x733de67aU);
