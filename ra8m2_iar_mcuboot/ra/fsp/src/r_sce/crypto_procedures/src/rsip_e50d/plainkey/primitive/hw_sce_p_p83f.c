                                           ...
                                           uint32_t       OutData_DataT[])
{
    ...
    HW_SCE_p_func100(0x4bc16f6eU, 0x8870506aU, 0x5d958acdU, 0xcdeb2e88U);
    WR1_PROG(REG_143CH, 0x00400000U);

    if (CHCK_STS(REG_143CH, 22, 1))
    {
        HW_SCE_p_func102(0x411c6508U, 0x7df7824aU, 0x46f4a82dU, 0x2395bd4dU);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0xd1ca0fcdU, 0xeaa68cd2U, 0x2064650eU, 0x1d6ad557U);
        WR1_PROG(REG_143CH, 0x00400000U);
        ...
        if (CHCK_STS(REG_143CH, 22, 1))
        {
            ...
            HW_SCE_p_func100(0xa44253c2U, 0xfd592010U, 0xc52e33f2U, 0x8acfb196U);
            ...
            HW_SCE_p_func101(0xbf387fb2U, 0x4cb3dd47U, 0xf593cec9U, 0xb39f26aeU);
        }

        HW_SCE_p_func100(0xaab9bac3U, 0xc0db631aU, 0x46c77b39U, 0xb3f371a1U);
        ...
        HW_SCE_p_func102(0x122e238aU, 0xd2896c87U, 0xec366364U, 0x49c250dcU);
        WR1_PROG(REG_14BCH, 0x00000040U);
        WAIT_STS(REG_142CH, 12, 0);
