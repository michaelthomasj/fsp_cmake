...
#define BSP_PARTITION_RAM_CPU0_S_SIZE (0x1000)
#define BSP_PARTITION_RAM_CPU0_C_START (0x20001000)
#define BSP_PARTITION_RAM_CPU0_C_SIZE (0x1000)
#define BSP_PARTITION_FLASH_CPU0_S_START (0x00000000)
#define BSP_PARTITION_FLASH_CPU0_S_SIZE (0x1400)
#define BSP_PARTITION_FLASH_CPU0_C_START (0x00001400)
#define BSP_PARTITION_FLASH_CPU0_C_SIZE (0x6C00)
