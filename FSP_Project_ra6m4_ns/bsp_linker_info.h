...
#define BSP_PARTITION_RAM_CPU0_C_SIZE (0x1800)
#define BSP_PARTITION_FLASH_CPU0_S_START (0x00000000)
#define BSP_PARTITION_FLASH_CPU0_S_SIZE (0x1000)
#define BSP_PARTITION_FLASH_CPU0_C_START (0x00001000)
#define BSP_PARTITION_FLASH_CPU0_C_SIZE (0x7000)
