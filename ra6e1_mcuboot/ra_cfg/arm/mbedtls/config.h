 ...
 */
            ...
            #endif
#if 0
            #define MBEDTLS_SHA3_PROCESS_ALT
            #endif
#if 0
 ...
 * \def MBEDTLS_MLKEM_C
 *
 * Enable the ML-KEM cryptosystem.
 *
 * Module:  library/mlkem.c
 * Caller:  library/psa_crypto.c *
 * Requires:
 */
#if 0
            #define MBEDTLS_MLKEM_C
            #endif

/**
 * \def MBEDTLS_ML_DSA_C
 *
 * Enable the ML-DSA cryptosystem.
 *
 * Module:  library/mldsa.c
 * Caller:  library/psa_crypto.c *
 * Requires:
 */
#if 0
            #define MBEDTLS_ML_DSA_C
            #endif
