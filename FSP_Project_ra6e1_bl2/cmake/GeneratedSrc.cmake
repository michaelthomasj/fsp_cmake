...
target_include_directories(${PROJECT_NAME}.elf
    ...
    ${CMAKE_CURRENT_SOURCE_DIR}/ra/arm/mbedtls/include
    ${CMAKE_CURRENT_SOURCE_DIR}/ra/arm/mbedtls/library
    ${CMAKE_CURRENT_SOURCE_DIR}/ra/fsp/inc
    ${CMAKE_CURRENT_SOURCE_DIR}/ra/fsp/inc/api
    ${CMAKE_CURRENT_SOURCE_DIR}/ra/fsp/inc/instances
    ${CMAKE_CURRENT_SOURCE_DIR}/ra/fsp/src/r_sce
    ${CMAKE_CURRENT_SOURCE_DIR}/ra/fsp/src/r_sce/common
    ${CMAKE_CURRENT_SOURCE_DIR}/ra/fsp/src/r_sce/crypto_procedures/src/sce9/plainkey/primitive
    ${CMAKE_CURRENT_SOURCE_DIR}/ra/fsp/src/r_sce/crypto_procedures/src/sce9/plainkey/private/inc
    ${CMAKE_CURRENT_SOURCE_DIR}/ra/fsp/src/r_sce/crypto_procedures/src/sce9/plainkey/public/inc
    ${CMAKE_CURRENT_SOURCE_DIR}/ra/fsp/src/rm_mcuboot_port
    ${CMAKE_CURRENT_SOURCE_DIR}/ra/fsp/src/rm_psa_crypto/inc
    ${CMAKE_CURRENT_SOURCE_DIR}/ra/mcu-tools/MCUboot/boot/bootutil/include
    ${CMAKE_CURRENT_SOURCE_DIR}/ra/mcu-tools/MCUboot/boot/bootutil/src
    ${CMAKE_CURRENT_SOURCE_DIR}/ra_cfg/arm
    ${CMAKE_CURRENT_SOURCE_DIR}/ra_cfg/arm/mbedtls
    ${CMAKE_CURRENT_SOURCE_DIR}/ra_cfg/fsp_cfg
    ${CMAKE_CURRENT_SOURCE_DIR}/ra_cfg/fsp_cfg/bsp
    ${CMAKE_CURRENT_SOURCE_DIR}/ra_cfg/mcu-tools/include
    ${CMAKE_CURRENT_SOURCE_DIR}/ra_cfg/mcu-tools/include/mcuboot_config
    ${CMAKE_CURRENT_SOURCE_DIR}/ra_cfg/mcu-tools/include/sysflash
