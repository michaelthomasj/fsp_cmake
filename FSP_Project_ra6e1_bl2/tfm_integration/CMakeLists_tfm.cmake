...
if(NOT TARGET fsp_bsp_bl2)
    ...
    file(GLOB FSP_BSP_BL2_SRC CONFIGURE_DEPENDS
        ...
        ${FSP_BL2_PROJECT_DIR}/ra/fsp/src/bsp/mcu/ra6e1/*.c
    ...
    # TF-M provides its own startup (startup_ra6e1.c), OFS emitter (bl2_option_setting.c),
    # and linker (ra6e1_bl2.ld with per-word OFS regions). FSP's startup.c/bsp_linker.c are
    # coupled to FSP's fsp.ld symbols (__ram_from_flash$$..., __Vectors) and would both
    # duplicate TF-M's symbols and pull in undefined FSP linker symbols - so exclude them.
    list(FILTER FSP_BSP_BL2_SRC EXCLUDE REGEX "/ra_gen/main\\.c$|/startup\\.c$|/bsp_linker\\.c$")
    ...
    target_include_directories(fsp_bsp_bl2
        PUBLIC
            ...
            ${FSP_BL2_PROJECT_DIR}/ra/fsp/src/bsp/mcu/ra6e1
