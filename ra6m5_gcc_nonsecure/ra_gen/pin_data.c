...
{ .pin = BSP_IO_PORT_01_PIN_11, .pin_cfg =
		((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) },
...
{ .pin = BSP_IO_PORT_02_PIN_04, .pin_cfg =
		((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) },

{ .pin = BSP_IO_PORT_02_PIN_05, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_SCI1_3_5_7_9) },

{ .pin = BSP_IO_PORT_02_PIN_06, .pin_cfg =
		((uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT
				| (uint32_t) IOPORT_CFG_PORT_OUTPUT_LOW) },

{ .pin = BSP_IO_PORT_02_PIN_07, .pin_cfg =
		((uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT
				| (uint32_t) IOPORT_CFG_PORT_OUTPUT_LOW) },
...
{ .pin = BSP_IO_PORT_02_PIN_14, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH
		| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_ETHER_RMII) },
...
{ .pin = BSP_IO_PORT_04_PIN_15, .pin_cfg =
		((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) },
...
{ .pin = BSP_IO_PORT_05_PIN_04, .pin_cfg =
		((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) },
...
{ .pin = BSP_IO_PORT_06_PIN_08, .pin_cfg =
		((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) },
...
{ .pin = BSP_IO_PORT_07_PIN_07, .pin_cfg =
		((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) },

{ .pin = BSP_IO_PORT_07_PIN_08, .pin_cfg =
		((uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT
				| (uint32_t) IOPORT_CFG_PORT_OUTPUT_LOW) },
...
{ .pin = BSP_IO_PORT_08_PIN_02, .pin_cfg = ((uint32_t) IOPORT_CFG_IRQ_ENABLE
		| (uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) },
