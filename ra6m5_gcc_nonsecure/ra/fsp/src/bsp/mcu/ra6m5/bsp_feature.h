...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS_MASK                            (0x37FFUL)      // Mask of available channels in ADC unit 0.
#define BSP_FEATURE_ADC_UNIT_1_CHANNELS_MASK                            (0x1FFF0007UL)  // Mask of available channels in ADC unit 1.
...
#define BSP_FEATURE_SCI_ADDRESS_MATCH_CHANNELS_MASK                     (0x03F9UL)      // Mask of channels with data compare match (DCCR) available.
...
#define BSP_FEATURE_SCI_LIN_CHANNELS_MASK                               (0x06UL)        // Mask of channels that can support LIN.
#define BSP_FEATURE_SCI_SPI_SCKSEL_MASK                                 (0UL)           // Mask indicating CCR4.SCKSEL is available.
#define BSP_FEATURE_SCI_UART_ABCSE_RESTRICTED_CHANNELS_MASK             (0x06UL)        // List of channels that do not support ABCSE functionality.
#define BSP_FEATURE_SCI_UART_CSTPEN_CHANNELS_MASK                       (0x03F9UL)      // Mask of channels which support CTS external pins.
...
#define BSP_FEATURE_SCI_UART_FIFO_CHANNELS_MASK                         (0x03F9UL)      // Mask of channels which support the UART FIFO.
