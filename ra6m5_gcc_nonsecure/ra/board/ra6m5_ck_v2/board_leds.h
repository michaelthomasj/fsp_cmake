...
/*******************************************************************************************************************//**
 * @ingroup BOARD_RA6M5_2_CK
 * @defgroup BOARD_RA6M5_2_CK_LEDS Board LEDs
...
typedef enum e_bsp_led
{
    ...
    BSP_LED_LED6_RED,                  ///< LED6_TRI_COLOUR_RED
    BSP_LED_LED6_GREEN,                ///< LED6_TRI_COLOUR_GREEN
    BSP_LED_LED6_BLUE,                 ///< LED6_TRI_COLOUR_BLUE
} bsp_led_t;
...
/** @} (end defgroup BOARD_RA6M5_2_CK_LEDS) */
