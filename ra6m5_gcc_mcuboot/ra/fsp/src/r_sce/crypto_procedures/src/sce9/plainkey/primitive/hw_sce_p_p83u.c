...
void HW_SCE_Aes192GcmEncryptUpdateSub (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    {
        0x3eb1fa6aU, 0x3624eb6eU, 0x0d9b82f1U, 0x276dabe6U,
    };
    HW_SCE_p_func100(Param_p83u_func100_001);
    ...
    {
        0xee297a68U, 0x4d9b7c56U, 0x83350b73U, 0x53e523b8U,
    };
    HW_SCE_p_func101(Param_p83u_func101_001);
}
