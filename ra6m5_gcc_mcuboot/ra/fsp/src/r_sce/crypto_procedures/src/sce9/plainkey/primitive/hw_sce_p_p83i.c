...
fsp_err_t HW_SCE_Aes192GcmEncryptInitSub (uint32_t InData_KeyIndex[], uint32_t InData_IV[])
{
    ...
    HW_SCE_p_func_sub009(0x800103a0U, 0x00000083U);

    static const uint32_t Param_p83i_func101_001[] =
    {
        0x84ac02c5U, 0x8dd0a073U, 0x6dc9b82fU, 0x03d41e37U,
    };
    HW_SCE_p_func101(Param_p83i_func101_001);
    HW_SCE_p_func043();

    WR1_PROG(REG_ECH, 0x0000b4e0U);
    HW_SCE_p_func_sub005(0x00000006U, 0x00000058U, 0x800103a0U, 0x00000083U);

    static const uint32_t Param_p83i_func101_002[] =
    {
        0x2c8ad926U, 0x3de8b014U, 0x034a1235U, 0xa559cac1U,
    };
    HW_SCE_p_func101(Param_p83i_func101_002);
    HW_SCE_p_func044();

    static const uint32_t Param_p83i_func100_001[] =
    {
        0x18660b22U, 0xc964460cU, 0x67195656U, 0x108283bbU,
    };
    HW_SCE_p_func100(Param_p83i_func100_001);
    ...
    {
        0x9e08e9ddU, 0x0668ff5dU, 0x3e762a11U, 0x9dbfad92U,
    };
    HW_SCE_p_func100(Param_p83i_func100_002);
    ...
    {
        0xc5a33008U, 0xbc8de0f9U, 0xd2585b7fU, 0x28c85160U,
    };
    HW_SCE_p_func100(Param_p83i_func100_003);
    ...
    if (CHCK_STS(REG_1CH, 22, 1))
    {
        ...
        {
            0x5ce71104U, 0x38d31448U, 0xe322ccd5U, 0x19656ec0U,
        };
        HW_SCE_p_func102(Param_p83i_func102_001);
