...
/** Public FSP version name. */
 #define FSP_VERSION_STRING          ("6.6.0-rc1+20260825.12bcfa5e")

/** Unique FSP version ID. */
 #define FSP_VERSION_BUILD_STRING    ("Built with Renesas Advanced Flexible Software Package version 6.6.0-rc1+20260825.12bcfa5e")
